...
INSERT INTO product
(description, image_url, name, publish_date, status, total_chapter, `type`, author_id)
VALUES('description', 'http://placehold.it/32x32', 'product name 2', '2020-10-17 16:00:00.0', 'PUBLISHING', 200, 'TRANSLATED', null);
INSERT INTO product
(description, image_url, name, publish_date, status, total_chapter, `type`, author_id)
VALUES('description', 'http://placehold.it/32x32', 'product name 3', '2020-10-18 16:00:00.0', 'PUBLISHING', 300, 'TRANSLATED', null);
